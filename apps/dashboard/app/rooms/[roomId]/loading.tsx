...
/**
 * Автоматический loading для страницы деталей комнаты
 */
    ...
    <div className="min-h-screen p-8">
      <div className="max-w-4xl mx-auto">
        <div className="mb-6">
          ...
          <div className="h-10 w-80 bg-surface-200 rounded animate-pulse mb-2" />
          <div className="h-4 w-64 bg-surface-200 rounded animate-pulse" />
        </div>
        <AutoLoading variant="grid" cols={2} />
        <div className="mt-6">
          <AutoLoading variant="card" />
        </div>
      </div>
    </div>
  );
