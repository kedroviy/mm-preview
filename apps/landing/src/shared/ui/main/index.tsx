        ...
        <div className="card flex flex-col items-center overflow-hidden pt-16">
            ...
            <div className="flex flex-wrap justify-center gap-8">
                ...
                >
                    ...
                    <span className="text-muted-color text-center">Мы подбираем фильмы по твоему вкусу — жанры, актёры и настроение, всё учитывается.</span>
                </AnimateOnScroll>
                <AnimateOnScroll
                    className="flex flex-col border border-surface shadow-lg justify-center items-center max-w-80 rounded-2xl p-8 gap-4"
                ...
                >
                    ...
                    <span className="text-muted-color text-center">Создавай подборки, голосуй вместе с друзьями и находи идеальный фильм для вечера.</span>
                </AnimateOnScroll>
                <AnimateOnScroll className="flex flex-col border border-surface shadow-lg justify-center items-center max-w-80 rounded-2xl p-8 gap-4" enterClassName="animate-enter fade-in-10 slide-in-from-r-8 animate-duration-1000">
                    ...
                    <span className="text-muted-color text-center">Умный алгоритм учитывает твои оценки и привычки, предлагая всё точнее с каждым просмотром.</span>
                </AnimateOnScroll>
            </div>
            <div className="h-[30rem]"></div>
            <div className="flex flex-wrap justify-center gap-8">
                ...
                >
                    ...
                    <span className="text-muted-color text-center">Не знаю как я жила без этого раньше!</span>
                </AnimateOnScroll>
                <AnimateOnScroll
                    className="flex flex-col border border-primary-200 shadow-lg justify-center items-center max-w-80 rounded-2xl p-8 gap-4"
                ...
                >
                    ...
                    <span className="text-muted-color text-center">Никогда бы не узнал про генеральские котлы без этого приложения</span>
                </AnimateOnScroll>
                <AnimateOnScroll
                    className="flex flex-col border border-primary-200 shadow-lg justify-center items-center max-w-80 rounded-2xl p-8 gap-4"
                    enterClassName="animate-enter fade-in-10 slide-in-from-t-20 animate-duration-1000"
            ...
            <div className="flex flex-col items-center gap-8 w-full">
                <AnimateOnScroll enterClassName="animate-enter fade-in-10 slide-in-from-b-16 animate-duration-1000" leaveClassName="animate-leave fade-out-0 animate-duration-100">
                    <div className="text-5xl lg:text-7xl text-center font-bold max-w-lg lg:max-w-3xl text-surface-900 dark:text-surface-50">Choosing a movie in the company of friends or spouses.</div>
                </AnimateOnScroll>
                <AnimateOnScroll enterClassName="animate-enter fade-in-10 slide-in-from-b-16 animate-duration-1000" leaveClassName="animate-leave fade-out-0 animate-duration-100">
                    <div className="max-w-md lg:max-w-2xl text-lg lg:text-xl text-center text-muted-color">No more arguments when choosing a movie.
                        You create a lobby, invite a friend and start selecting a movie to watch.</div>
                </AnimateOnScroll>
                <AnimateOnScroll enterClassName="animate-enter fade-in-10 slide-in-from-b-16 animate-duration-1000" leaveClassName="animate-leave fade-out-0 animate-duration-100">
                    <div className="flex items-center justify-center gap-4">
                        <Button rounded onClick={handleCreateUser} className="text-lg px-6 py-3">
                            Create Account
                        </Button>
                        <Button outlined rounded severity="secondary" className="text-lg px-6 py-3">
                            See our plans
                        </Button>
                    </div>
                </AnimateOnScroll>
