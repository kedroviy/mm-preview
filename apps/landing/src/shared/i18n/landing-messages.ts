...
export type LandingDictionary = Readonly<{
    header: HeaderCopy;
...
export const FALLBACK_HEADER_COPY: Record<SupportedLocale, HeaderCopy> = {
    ru: {
        features: FALLBACK_MESSAGES.ru['header.features'],
        guides: FALLBACK_MESSAGES.ru['header.guides'],
        download: FALLBACK_MESSAGES.ru['header.download'],
        faq: FALLBACK_MESSAGES.ru['header.faq'],
        reviews: FALLBACK_MESSAGES.ru['header.reviews'],
        start: FALLBACK_MESSAGES.ru['header.start'],
        startAria: FALLBACK_MESSAGES.ru['header.startAria'],
        brandAria: FALLBACK_MESSAGES.ru['header.brandAria'],
        langAria: FALLBACK_MESSAGES.ru['header.langAria'],
    },
    en: {
        features: FALLBACK_MESSAGES.en['header.features'],
        guides: FALLBACK_MESSAGES.en['header.guides'],
        download: FALLBACK_MESSAGES.en['header.download'],
        faq: FALLBACK_MESSAGES.en['header.faq'],
        reviews: FALLBACK_MESSAGES.en['header.reviews'],
        start: FALLBACK_MESSAGES.en['header.start'],
        startAria: FALLBACK_MESSAGES.en['header.startAria'],
        brandAria: FALLBACK_MESSAGES.en['header.brandAria'],
        langAria: FALLBACK_MESSAGES.en['header.langAria'],
    },
    es: {
        features: FALLBACK_MESSAGES.es['header.features'],
        guides: FALLBACK_MESSAGES.es['header.guides'],
        download: FALLBACK_MESSAGES.es['header.download'],
        faq: FALLBACK_MESSAGES.es['header.faq'],
        reviews: FALLBACK_MESSAGES.es['header.reviews'],
        start: FALLBACK_MESSAGES.es['header.start'],
        startAria: FALLBACK_MESSAGES.es['header.startAria'],
        brandAria: FALLBACK_MESSAGES.es['header.brandAria'],
        langAria: FALLBACK_MESSAGES.es['header.langAria'],
    },
};
...
export function normalizeSwitcherLocales(
    ...
    const supported = source.filter(
        (item): item is SupportedLocale =>
            item === 'ru' || item === 'en' || item === 'es',
    );
